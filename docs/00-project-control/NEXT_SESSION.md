...
Следующий пункт: если продолжаем документацию - сделать короткий список задач следующей рабочей сессии; если начинаем разработку - сначала запросить файл-инструкцию владельца проекта, затем использовать `docs/10-mvp-roadmap/start-development-prompt.md`.
