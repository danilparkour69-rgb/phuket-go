...
Перед началом разработки нужно запросить у пользователя файл с инструкцией, дождаться его, прочитать и только после этого переходить к коду.
...
- Перед началом разработки обязательно запросить файл с инструкцией у пользователя.
...
- финальная сверка документов подготовки MVP сохранена в `docs/00-project-control/final-mvp-docs-consistency-review.md`;

Следующий пункт: если продолжаем документацию - сделать короткий список задач следующей рабочей сессии; если начинаем разработку - использовать `docs/10-mvp-roadmap/start-development-prompt.md`.
...
5. Следующий шаг - финальная сверка документов подготовки MVP перед будущим стартом разработки.
6. Код проекта пока не писать.
...
`Продолжаем Phuket Go. Код проекта не писать. Открой docs/00-project-control/NEXT_SESSION.md, docs/00-project-control/master-plan.md, docs/10-mvp-roadmap/development-handoff-map.md и docs/10-mvp-roadmap/immediate-pre-coding-actions.md. Фото больше не блокируют работу: берем доступные фото из папки направления, если они соответствуют карточке экскурсии; финальную чистку фото оставляем перед публикацией. Следующий шаг - сделать короткую финальную сверку документов подготовки MVP и проверить, нет ли устаревших формулировок перед будущим стартом разработки. Код проекта не писать.`
